...
$Journalists = @(
    @{ username = "arif-hasan"; displayName = "আরিফ হাসান"; designation = "সম্পাদক"; role = "editor"; emailPublic = "arif.hasan@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-arif/480/480"; bio = "ডেমো নিউজরুমের সম্পাদক। জাতীয় ও নীতি-সংক্রান্ত প্রতিবেদনের পরিকল্পনা ও সম্পাদনায় যুক্ত।" },
    @{ username = "nusrat-jahan"; displayName = "নুসরাত জাহান"; designation = "বার্তা সম্পাদক"; role = "editor"; emailPublic = "nusrat.jahan@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-nusrat/480/480"; bio = "বার্তা প্রবাহ, শিরোনাম ও প্রকাশনার সময়সূচি সমন্বয় করেন।" },
    @{ username = "mehedi-rahman"; displayName = "মেহেদী রহমান"; designation = "জ্যেষ্ঠ প্রতিবেদক"; role = "reporter"; emailPublic = "mehedi.rahman@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-mehedi/480/480"; bio = "অর্থনীতি, নাগরিক সেবা ও মাঠপর্যায়ের প্রতিবেদনে কাজ করেন।" },
    @{ username = "sabiha-islam"; displayName = "সাবিহা ইসলাম"; designation = "প্রতিবেদক"; role = "reporter"; emailPublic = "sabiha.islam@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-sabiha/480/480"; bio = "শিক্ষা, স্বাস্থ্য ও নগর জীবনের গল্প নিয়ে কাজ করেন।" },
    @{ username = "rakibul-islam"; displayName = "রাকিবুল ইসলাম"; designation = "ক্রীড়া প্রতিবেদক"; role = "reporter"; emailPublic = "rakibul.islam@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-rakibul/480/480"; bio = "ক্রিকেট, ফুটবল ও তরুণ খেলোয়াড়দের প্রস্তুতি নিয়ে প্রতিবেদন করেন।" },
    @{ username = "tanvir-ahmed"; displayName = "তানভীর আহমেদ"; designation = "আন্তর্জাতিক ডেস্ক"; role = "reporter"; emailPublic = "tanvir.ahmed@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-tanvir/480/480"; bio = "আন্তর্জাতিক ঘটনাপ্রবাহ ও আঞ্চলিক সহযোগিতা বিষয়ক ডেস্ক কনটেন্ট প্রস্তুত করেন।" },
    @{ username = "farhana-kabir"; displayName = "ফারহানা কবির"; designation = "বিনোদন প্রতিবেদক"; role = "reporter"; emailPublic = "farhana.kabir@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-farhana/480/480"; bio = "সংস্কৃতি, চলচ্চিত্র, নাটক ও সৃজনশীল উদ্যোগ নিয়ে লিখেন।" },
    @{ username = "imran-hossain"; displayName = "ইমরান হোসেন"; designation = "ফটো সাংবাদিক"; role = "reporter"; emailPublic = "imran.hossain@example.com"; profileImageUrl = "https://picsum.photos/seed/alochito-imran/480/480"; bio = "ছবি, ভিজ্যুয়াল স্টোরি ও মাঠের ডকুমেন্টেশনে কাজ করেন।" }
)
