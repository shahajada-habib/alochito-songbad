...
public class PublicNewsController {
    ...
    public Object getPublishedNewsByTag(
    ...
    public ResponseEntity<PublicViewCountResponse> incrementPublishedViewCount(@PathVariable Long id) {
        return newsService.incrementPublishedViewCount(id)
